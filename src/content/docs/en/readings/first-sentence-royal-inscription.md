...
- As in `lugal-e`, the subject of a transitive verb (`du3`, "to build") takes the ergative suffix `-e` (see [Ergative and Absolutive Case](/en/grammar/sumerian-ergative/)).
...
- [Readings & Examples: Reading Sumerian Personal Names](/en/readings/reading-personal-names/)
