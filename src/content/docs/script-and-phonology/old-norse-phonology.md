...
古ノルド語は短母音9個・長母音9個という、当時のゲルマン諸語の中でも特に豊かな母音体系を持つ。長短はそれぞれ独立して意味を弁別する（[古ノルド語の翻字規則](/script-and-phonology/old-norse-transliteration/)を参照）。
...
より顕著な例として、名詞 *fótr*（足）と *fœtr*（足たち、複数）の対応があり、ó が œ に変化しているのがわかる。この交替は後の記事「[強変化名詞と弱変化名詞](/grammar/strong-weak-nouns/)」でも扱う。
...
- [文字と音韻: 古ノルド語の翻字規則（標準化正書法）](/script-and-phonology/old-norse-transliteration/)
