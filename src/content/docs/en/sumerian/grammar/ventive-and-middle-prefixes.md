---
title: "The Ventive Prefix mu- and the Middle-Voice Prefix ba-/bi2-"
description: The contrast between the verbal prefix mu- (ventive, "toward the speaker") and ba- (middle voice, a viewpoint away from the speaker), illustrated with the verb gi4 "to return."
topic: sumerian
sidebar:
  order: 16
---

## The stars of the "direction/voice" slot

In [The Verbal Prefix Chain: A Structural Overview](/en/sumerian/grammar/verbal-prefix-chain-overview/), slot ② ("directional/voice prefix") is home to two especially important elements: `mu-` (ventive) and `ba-` (middle voice). [Person Affixes and the Basic Verb Structure](/en/sumerian/grammar/personal-affixes-verb-basics/) already introduced the basic function of `mu-`; this article digs a bit deeper by contrasting it with `ba-` and `bi2-`.

## mu-: toward the speaker (the ventive center)
...
mu-gi4
VENT-return
"he returned it (hither, toward here)"
```

## ba-: middle voice, an event viewed from a distance
...
<div class="plc-column">
  ...
  <div class="plc-body">
    <p class="plc-title">💬 Learning Column: mu- and ba- as Camera Zoom</p>
    <p class="plc-line"><b>Nin:</b> `mu-gi4` and `ba-gi4` both mean "return," but they feel so different.</p>
    <p class="plc-line"><b>En:</b> Think of it as camerawork. `mu-` zooms the lens in tight on the speaker or narrator. `ba-`, on the other hand, pulls the camera back, viewing the event from a bit of a distance.</p>
    <p class="plc-line"><b>Nin:</b> So the same verb "return" changes between `mu-` and `ba-` depending on where the camera is sitting.</p>
    <p class="plc-line"><b>En:</b> Once you see it that way, verbal prefixes aren't just grammatical decoration — they're a tool for controlling the story's point of view.</p>
  </div>
</div>
